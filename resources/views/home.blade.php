    ...
    <div class="py-12 w-full overflow-y-auto">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-rows-1">
                <a href="" class="focus:outline-none text-blue-600 text-sm py-2.5 px-5 border border-blue-600 hover:bg-blue-50 py-2 mb-4 text-center">Realizar Nova Reserva</a>
            </div>
            <div class="grid grid-rows-1 bg-white px-4 pb-4 rounded-xl">

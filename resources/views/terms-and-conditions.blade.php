...
<html lang="en">
    ...
    <body class="mx-8">
        <p class="font-bold">TERMOS DE USO — Gerenciador de Equipamentos</p>
        <p class="text-justify">
        Gerenciador de Equipamentos, pessoa jurídica de direito privado descreve, através deste documento, as regras de uso do site https://acustica.app e qualquer outro site, loja ou aplicativo operado pelo proprietário.
...
A utilização deste website após as alterações significa que você aceitou os Termos de Uso revisados. Caso, após a leitura da versão revisada, você não esteja de acordo com seus termos, favor encerrar o seu acesso.
        ...
        <p class="font-bold mt-4">Seção 1 - Usuário</p>
        <p class="text-justify">
        ...
        <p class="font-bold mt-4">Seção 2 - Adesão em conjunto com a Política de Privacidade</p>
        <p class="text-justify">
        A utilização deste website acarreta a adesão aos presentes Termos de Uso e a versão mais atualizada da Política de Privacidade de Gerenciador de Equipamentos.
        </p>
        <p class="font-bold mt-4">Seção 3 - Condições de acesso</p>
        <p class="text-justify">
...
Partes deste website oferecem ao usuário a opção de publicar comentários em determinadas áreas. Gerenciador de Equipamentos não consente com a publicação de conteúdos que tenham natureza discriminatória, ofensiva ou ilícita, ou ainda infrinjam direitos de autor ou quaisquer outros direitos de terceiros.
A publicação de quaisquer conteúdos pelo usuário deste website, incluindo mensagens e comentários, implica em licença não-exclusiva, irrevogável e irretratável, para sua utilização, reprodução e publicação pela Gerenciador de Equipamentos no seu website, plataformas e aplicações de internet, ou ainda em outras plataformas, sem qualquer restrição ou limitação.
        </p>

        <p class="font-bold mt-4">Seção 4 - Cookies</p>
        <p class="text-justify">
...
As definições que escolher podem afetar a sua experiência de navegação e o funcionamento que exige a utilização de cookies. Neste sentido, rejeitamos qualquer responsabilidade pelas consequências resultantes do funcionamento limitado deste website provocado pela desativação de cookies no seu dispositivo (incapacidade de definir ou ler um cookie).
        ...
        <p class="font-bold mt-4">Seção 5 - Propriedade Intelectual</p>
        <p class="text-justify">
        Todos os elementos de Gerenciador de Equipamentos são de propriedade intelectual da mesma ou de seus licenciados. Estes Termos ou a utilização do website não concede a você qualquer licença ou direito de uso dos direitos de propriedade intelectual da Gerenciador de Equipamentos ou de terceiros.
</p>

        <p class="font-bold mt-4">Seção 6 - Links para sites de terceiros</p>
        <p class="text-justify">
...
Não nos responsabilizamos pelas políticas e práticas de coleta, uso e divulgação (incluindo práticas de proteção de dados) de outras organizações, tais como Facebook, Apple, Google, Microsoft, ou de qualquer outro desenvolvedor de software ou provedor de aplicativo, loja de mídia social, sistema operacional, prestador de serviços de internet sem fio ou fabricante de dispositivos, incluindo todos os Dados Pessoais que divulgar para outras organizações por meio dos aplicativos, relacionadas a tais aplicativos, ou publicadas em nossas páginas em mídias sociais. Nós recomendamos que você se informe sobre a política de privacidade e termos de uso de cada site visitado ou de cada prestador de serviço utilizado.
        ...
        <p class="font-bold mt-4">Seção 7 - Prazos e alterações</p>
        <p class="text-justify">
        O funcionamento deste website se dá por prazo indeterminado.
O website no todo ou em cada uma das suas seções, pode ser encerrado, suspenso ou interrompido unilateralmente por Gerenciador de Equipamentos, a qualquer momento e sem necessidade de prévio aviso.
</p>

        <p class="font-bold mt-4">Seção 8 - Dados pessoais</p>
        <p class="text-justify">
        Durante a utilização deste website, certos dados pessoais serão coletados e tratados por Gerenciador de Equipamentos e/ou pelos Parceiros. As regras relacionadas ao tratamento de dados pessoais de Gerenciador de Equipamentos estão estipuladas na Política de Privacidade.
</p>
<p class="font-bold mt-4">Seção 9 - Contato</p>
        <p class="text-justify">
        Caso você tenha qualquer dúvida sobre os Termos de Uso, por favor, entre em contato pelo e-mail giuliano.arnhold@eac.ufsm.br.</p>
    </body>
</html>